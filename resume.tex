...
\begin{itemize}
     \item Developed RESTful API back end using C\# + .NET 6, facilitating communication between multiple systems.
    ...
    \item Conducted load testing with JMeter and maintained automated tests for software robustness.
\end{itemize}
